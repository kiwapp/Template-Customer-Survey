...
(function(){
    ...
    **/
    ...
    Driver.prototype.rotate = function(orientation){
        ...
        if(orientation === 'landscape') orientation = 10;
        else if(orientation === 'portrait') orientation = 5;
...
},{"../../utils/event":11,"../../utils/extend":12,"../../utils/increaseCapability":14,"../../utils/model":16}],3:[function(require,module,exports){
'use strict';
(function(){
...
(function(){
    ...
    **/
    ...
    /**
     * store config and driver in private variables to avoid user modifications
     */
    var config, driver;
...
},{"../utils/utils":17,"./driver/android":1,"./driver/iOS":3,"./driver/web":4,"./stats/session":6,"./stats/stats":7,"./version":8}],6:[function(require,module,exports){
'use strict';
(function(){
    /**
    *  browserify modules dependencies
...
},{"../../libs/md5":9,"../../utils/ajax":10,"../../utils/extend":12}],7:[function(require,module,exports){
'use strict';
(function(){
...
},{"../../utils/getDate":13}],8:[function(require,module,exports){
...
/* jshint ignore:end */
},{"type-of":18}],11:[function(require,module,exports){
'use strict';
(function(){
...
},{"./ajax":10,"./event":11,"./extend":12,"./getDate":13,"./increaseCapability":14,"./loadJS":15,"./model":16}],18:[function(require,module,exports){
